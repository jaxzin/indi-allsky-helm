...
Before production use, read its credential-lifecycle, backup-protection, and
restore sections: changing a Kubernetes Secret does not rotate an initialized
MariaDB account, and compressed SQL dumps are not encrypted recovery sets by
themselves.
